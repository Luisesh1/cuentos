class BackgroundsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @background.save
        save_palabras(@background,params[:palabras])
  ...
  private
    ...
    def background_params
      params.require(:background).permit(:titulo,:foto)
    end
     def save_palabras(imagen,palabras)
      ...
      apal.each do |palabra|
        ...
        unless aux.nil?
          imagen.background_words.create(word_id: aux.id)
          else 
    ...
    def delete_ref  (imagen)
      imagen.background_words.delete_all
    end
end
